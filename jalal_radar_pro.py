...
def monitor_positions():
    ...
    for pos in positions:
        ...
        # ── تجاهل السهم لو عنده أمر بيع معلّق ──
        if norm in symbols_with_pending_sell:
            # (v3.3) الرسالة مرة واحدة لكل سهم باليوم — كانت تغرق اللوق كل دورة
        ...
        # ── حماية: مركز شورت (qty سالبة) ما تدعمه الاستراتيجية أصلاً ──
        # كان يتجاهله الكود القديم بالكامل (qty<=0 → continue) بدون أي حماية،
        # وهذا اللي خلى HON ينزف -95% بدون وقف خسارة أو أي تدخل.
        # الحل: أي شورت نكتشفه نقفله فوراً بأمر سوق ونسجله كحادثة.
        if qty < 0:
