...
def analyze_symbol(code, name, is_crypto=False, live_price=None):
    ...
    try:
        ...
        return {
            ...
            "above_daily":ad, "above_weekly":aw,
        }
    except Exception as e:
        return None
...
function renderSig(s) {
  ...
  return '<div class="sig">'+
    ...
    '<div class="sig-id"><div class="sig-name">'+s.name+'<span class="sig-code">'+s.code+'</span></div>'+
    '<div class="sig-meta">RSI '+s.rsi+' · ADX '+s.adx+' · حجم ×'+s.vr+'</div></div>'+
